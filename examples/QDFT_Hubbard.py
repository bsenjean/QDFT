...
for U in U_list:
    ...
    output_file = working_directory + "examples/results/L{}_N{}_U{}_{}_{}_nshots{}_layer{}_maxiter{}_resampling{}_slopeSPSA{}_slopeSCF{}_{}.dat".format(n_sites,n_elec,U,opt_method,potential,nshots,n_blocks,opt_maxiter,resampling,slope_SPSA,slope_SCF,simulation)
    ...
    for SCF_ITER in range(1,SCF_maxiter+1):
        ...
        subprocess.check_call("echo " + str(U) + " " + str(t) + " | beta_and_derivatives",shell=True, cwd = working_directory + "/examples/results/")
        with open(working_directory + "/examples/results/beta_dbetadU.dat","r") as f:
          line = f.read()
